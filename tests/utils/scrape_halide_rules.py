"""
This is a modified version of the script present in ruler/scripts/scrape_halide_rules.py.
I didn't want to make a fork of Ruler just to make this small change.
"""
